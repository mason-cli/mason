...
var exec = _util2.default.promisify(_child_process3.default.exec);
...
var Application = function () {
  ...
  */
   ...
   */
		...
		key: "run",
		value: function () {
			var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee(cmd, options) {
				var obj, command;
					...
					while (1) {
						switch (_context.prev = _context.next) {
							...
							case 11:
								...
								_context.next = 14;
								return command.run(options, this.config);
							...
							case 18:
								...
								console.error("Error! ", _context.t1.message ? _context.t1.message : _context.t1);
								if (_context.t1.stack) {
									console.log(_util2.default.inspect(_context.t1.stack, false, null));
								}
   ...
   */
		...
		value: function exec(command) {
			...
			return new _es6Promise2.default(function (resolve, reject) {
				return _child_process3.default.exec(command, options, function (err, stdout, stderr) {
					if (err) {
						reject(err);
					} else {
