...
var _Command4 = require('./Command');

var _Command5 = _interopRequireDefault(_Command4);
...
exports.default = function (Mason) {
	...
	var ScaffoldCommand = function (_Command3) {
		_inherits(ScaffoldCommand, _Command3);

		function ScaffoldCommand() {
			_classCallCheck(this, ScaffoldCommand);

			return _possibleConstructorReturn(this, (ScaffoldCommand.__proto__ || Object.getPrototypeOf(ScaffoldCommand)).apply(this, arguments));
		}

		_createClass(ScaffoldCommand, [{
			key: 'run',
			value: function run(resolve, reject) {
