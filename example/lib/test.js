...
var _Command2 = require('../../lib/cli/Command');
...
var TestCommand = function (_Command) {
	_inherits(TestCommand, _Command);

	function TestCommand() {
		_classCallCheck(this, TestCommand);

		return _possibleConstructorReturn(this, (TestCommand.__proto__ || Object.getPrototypeOf(TestCommand)).apply(this, arguments));
	}
